 ...
 * 
 * @export
 * @interface SpacecraftConfigType
 */
export interface SpacecraftConfigType {
    /**
     * 
     * @type {number}
     * @memberof SpacecraftConfigType
     */
    readonly id: number;
    /**
     * 
...
export function SpacecraftConfigTypeFromJSON(json: any): SpacecraftConfigType {
    return SpacecraftConfigTypeFromJSONTyped(json, false);
}

export function SpacecraftConfigTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SpacecraftConfigType {
...
export function SpacecraftConfigTypeToJSON(value?: SpacecraftConfigType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
