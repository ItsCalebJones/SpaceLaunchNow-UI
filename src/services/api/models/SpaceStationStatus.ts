...
export function SpaceStationStatusFromJSON(json: any): SpaceStationStatus {
    return SpaceStationStatusFromJSONTyped(json, false);
}

export function SpaceStationStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): SpaceStationStatus {
...
export function SpaceStationStatusToJSON(value?: SpaceStationStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
