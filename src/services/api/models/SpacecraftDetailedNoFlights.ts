 ...
 * 
 * @export
 * @interface SpacecraftDetailedNoFlights
 */
export interface SpacecraftDetailedNoFlights {
    /**
     * 
     * @type {number}
     * @memberof SpacecraftDetailedNoFlights
     */
    readonly id: number;
    /**
     * 
...
export function SpacecraftDetailedNoFlightsFromJSON(json: any): SpacecraftDetailedNoFlights {
    return SpacecraftDetailedNoFlightsFromJSONTyped(json, false);
}

export function SpacecraftDetailedNoFlightsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SpacecraftDetailedNoFlights {
...
export function SpacecraftDetailedNoFlightsToJSON(value?: SpacecraftDetailedNoFlights | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
