...
export function AstronautStatusFromJSON(json: any): AstronautStatus {
    return AstronautStatusFromJSONTyped(json, false);
}

export function AstronautStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): AstronautStatus {
...
export function AstronautStatusToJSON(value?: AstronautStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
