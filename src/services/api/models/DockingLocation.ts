...
export function DockingLocationFromJSON(json: any): DockingLocation {
    return DockingLocationFromJSONTyped(json, false);
}

export function DockingLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): DockingLocation {
...
export function DockingLocationToJSON(value?: DockingLocation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
