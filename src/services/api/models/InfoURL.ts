...
export function InfoURLFromJSON(json: any): InfoURL {
    return InfoURLFromJSONTyped(json, false);
}

export function InfoURLFromJSONTyped(json: any, ignoreDiscriminator: boolean): InfoURL {
...
export function InfoURLToJSON(value?: InfoURL | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
