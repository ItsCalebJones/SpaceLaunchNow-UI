...
export function OrbitFromJSON(json: any): Orbit {
    return OrbitFromJSONTyped(json, false);
}

export function OrbitFromJSONTyped(json: any, ignoreDiscriminator: boolean): Orbit {
...
export function OrbitToJSON(value?: Orbit | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
