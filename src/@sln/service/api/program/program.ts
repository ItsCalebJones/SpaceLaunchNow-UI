...
export const programList = (
  ...
  return axios.get(`/2.2.0/program/`, {
    params,
    ...options,
  });
};

export const getProgramListQueryKey = (params?: ProgramListParams) => [
  `/2.2.0/program/`,
  ...(params ? [params] : []),
];

export type ProgramListQueryResult = NonNullable<
  Awaited<ReturnType<typeof programList>>
>;
export type ProgramListQueryError = AxiosError<unknown>;

export const useProgramList = <
  TData = Awaited<ReturnType<typeof programList>>,
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof programList>>> = ({
    signal,
  }) => programList(params, { signal, ...axiosOptions });
...
export const programRetrieve = (
  ...
  return axios.get(`/2.2.0/program/${id}/`, options);
};

export const getProgramRetrieveQueryKey = (id: number) => [
  `/2.2.0/program/${id}/`,
];

export type ProgramRetrieveQueryResult = NonNullable<
  Awaited<ReturnType<typeof programRetrieve>>
>;
export type ProgramRetrieveQueryError = AxiosError<unknown>;

export const useProgramRetrieve = <
  TData = Awaited<ReturnType<typeof programRetrieve>>,
  TError = AxiosError<unknown>
>(
  id: number,
  options?: {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof programRetrieve>>> = ({
    signal,
  }) => programRetrieve(id, { signal, ...axiosOptions });
