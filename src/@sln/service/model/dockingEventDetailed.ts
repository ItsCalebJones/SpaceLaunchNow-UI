...
export interface DockingEventDetailed {
  ...
  readonly flight_vehicle: SpacecraftFlightSerializerForDockingEventDetailed;
  readonly docking_location: DockingLocation;
  readonly space_station: SpaceStationSerializerForDockingEvent;
}
