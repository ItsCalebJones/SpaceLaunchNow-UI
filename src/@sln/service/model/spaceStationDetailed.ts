...
export interface SpaceStationDetailed {
  ...
  onboard_crew: number;
  readonly owners: Agency[];
  readonly active_expeditions: ExpeditionDetailedSerializerForSpacestation[];
  readonly docking_location: DockingLocationSerializerForSpacestation[];
