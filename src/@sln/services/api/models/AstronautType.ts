...
export function AstronautTypeFromJSON(json: any): AstronautType {
    return AstronautTypeFromJSONTyped(json, false);
}

export function AstronautTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): AstronautType {
...
export function AstronautTypeToJSON(value?: AstronautType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
