 ...
 * 
 * @export
 * @interface PaginatedPadList
 */
export interface PaginatedPadList {
    /**
     * 
     * @type {number}
     * @memberof PaginatedPadList
     */
    count?: number;
    /**
     * 
...
export function PaginatedPadListFromJSON(json: any): PaginatedPadList {
    return PaginatedPadListFromJSONTyped(json, false);
}

export function PaginatedPadListFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaginatedPadList {
    ...
    return {
        ...
        'results': !exists(json, 'results') ? undefined : ((json['results'] as Array<any>).map(PadFromJSON)),
    };
}

export function PaginatedPadListToJSON(value?: PaginatedPadList | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'results': value.results === undefined ? undefined : ((value.results as Array<any>).map(PadToJSON)),
    };
}
