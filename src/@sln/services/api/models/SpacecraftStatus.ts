...
export function SpacecraftStatusFromJSON(json: any): SpacecraftStatus {
    return SpacecraftStatusFromJSONTyped(json, false);
}

export function SpacecraftStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): SpacecraftStatus {
...
export function SpacecraftStatusToJSON(value?: SpacecraftStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
