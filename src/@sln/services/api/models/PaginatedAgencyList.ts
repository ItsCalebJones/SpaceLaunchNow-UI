 ...
 * 
 * @export
 * @interface PaginatedAgencyList
 */
export interface PaginatedAgencyList {
    /**
     * 
     * @type {number}
     * @memberof PaginatedAgencyList
     */
    count?: number;
    /**
     * 
...
export function PaginatedAgencyListFromJSON(json: any): PaginatedAgencyList {
    return PaginatedAgencyListFromJSONTyped(json, false);
}

export function PaginatedAgencyListFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaginatedAgencyList {
    ...
    return {
        ...
        'results': !exists(json, 'results') ? undefined : ((json['results'] as Array<any>).map(AgencyFromJSON)),
    };
}

export function PaginatedAgencyListToJSON(value?: PaginatedAgencyList | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'results': value.results === undefined ? undefined : ((value.results as Array<any>).map(AgencyToJSON)),
    };
}
