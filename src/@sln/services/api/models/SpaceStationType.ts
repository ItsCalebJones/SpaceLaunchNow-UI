 ...
 * 
 * @export
 * @interface SpaceStationType
 */
export interface SpaceStationType {
    /**
     * 
     * @type {number}
     * @memberof SpaceStationType
     */
    readonly id: number;
    /**
     * 
...
export function SpaceStationTypeFromJSON(json: any): SpaceStationType {
    return SpaceStationTypeFromJSONTyped(json, false);
}

export function SpaceStationTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SpaceStationType {
...
export function SpaceStationTypeToJSON(value?: SpaceStationType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
