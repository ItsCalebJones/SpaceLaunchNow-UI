 ...
 * 
 * @export
 * @interface PaginatedMissionTypeList
 */
export interface PaginatedMissionTypeList {
    /**
     * 
     * @type {number}
     * @memberof PaginatedMissionTypeList
     */
    count?: number;
    /**
     * 
...
export function PaginatedMissionTypeListFromJSON(json: any): PaginatedMissionTypeList {
    return PaginatedMissionTypeListFromJSONTyped(json, false);
}

export function PaginatedMissionTypeListFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaginatedMissionTypeList {
    ...
    return {
        ...
        'results': !exists(json, 'results') ? undefined : ((json['results'] as Array<any>).map(MissionTypeFromJSON)),
    };
}

export function PaginatedMissionTypeListToJSON(value?: PaginatedMissionTypeList | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'results': value.results === undefined ? undefined : ((value.results as Array<any>).map(MissionTypeToJSON)),
    };
}
